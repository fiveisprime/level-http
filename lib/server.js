...
module.exports = function(config) {
  ...
  if (typeof config.port === 'undefined') throw new Error('You must specify a port.');

  if (typeof config.auth !== 'undefined') app.use(express.basicAuth(config.auth.username, config.auth.password));
